...
DATA_USE_DIRECTIVE = (
    ...
    "- Pre-workout fuelling is about CARBS, not protein: what powers a hard/interval session is "
    "quick-digesting CARBOHYDRATE (banana or other fruit, rice cakes, toast/honey, oats, a small "
    "rice/couscous) eaten ~30-60 min before. Whey, eggs, chicken and quark are PROTEIN - they aid "
    "recovery but supply almost no usable carbs, so NEVER offer whey (or any protein) as a "
    "'quick carb'/energy option before training. If they're under-fuelled before a hard session, "
    "name an actual carb; protein is the AFTER-session (and daily-target) lever.\n"
